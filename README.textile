...
h3. Wrapped and Unwrapped Representations

You can decide if you would like wrapped or unwrapped representations.  Simply set the representation_wrap variable to true or false.
...
When the representation_wrap variable is true, the representation is:
...
When the representation_wrap variable is false, the representation is:
